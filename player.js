    ...
    getBestMove(board, maximizing = true, callback = () => {}, depth = 0) {
        ...
        if (maximizing) {
            ...
            board.getAvailableMoves().forEach(index => {
                ...
                const nodeValue = this.getBestMove(child, false, callback, depth + 1);//O
                //Updating best value
                best = Math.max(best, nodeValue);//-100, -99
                //best -99
        ...
        if (!maximizing) {
            ...
            board.getAvailableMoves().forEach(index => {
                ...
                let nodeValue = this.getBestMove(child, true, callback, depth + 1); //x
                //Updating best value
                best = Math.min(best, nodeValue);//100, 101
